...
public class Utiles {
    public static void Log(String logText) {
        Log.e(LastNewsMVPApplication.LOG_TAG, logText);
    }
    ...
    public static int dpToPx(int dp) {
        DisplayMetrics displayMetrics = LastNewsMVPApplication.context.getResources().getDisplayMetrics();
    ...
    public static boolean isNetworkConnected() {
        ConnectivityManager conMgr =
                (ConnectivityManager) LastNewsMVPApplication.context.getSystemService(Context.CONNECTIVITY_SERVICE);
