...
public class LastNewsMVPApplication extends Application {
...
//        ir.ncompany.constrantlayout.helper.FontsOverride.setDefaultFont(this, "MONOSPACE", "font/BYEKAN.ttf");
        ...
        configRealm = new RealmConfiguration
                ...
                .name("BBC.realm")
                .build();
        android_id = Settings.Secure.getString(LastNewsMVPApplication.context.getContentResolver(),
    ...
    public static Retrofit getRetrofit() {
        retrofit = new Retrofit.Builder()
                .baseUrl(LastNewsMVPApplication.REST_API_ADDRESS)
